...
jQuery.fn.SharpCalendar = jQuery.fn.SC = function (options) {
	...
	(function () {
		...
		if (options.vertical) {
			...
			options.prvtYearWidth  = options.prvtYearSelWidth = Years.width() - 4 + "px";
			options.prvtMonthWidth  = options.prvtMonthSelWidth = Months.width() - 4 + "px";
			options.prvtDayWidth  = options.prvtDaySelWidth = Days.width() - 4 + "px";
			            
			options.prvtYearHeight  = parseInt((auxH - 4 - options.prvtYearNumCells * 4) / options.prvtYearNumCells, 10);
			options.prvtYearSelHeight = options.prvtYearHeight + auxH - (options.prvtYearNumCells * options.prvtYearHeight + options.prvtYearNumCells * 4);
            options.prvtMonthHeight  = parseInt((auxH - 4 - options.prvtMonthNumCells * 4) / options.prvtMonthNumCells, 10);
			options.prvtMonthSelHeight = options.prvtMonthHeight + auxH - (options.prvtMonthNumCells * options.prvtMonthHeight + options.prvtMonthNumCells * 4);
			options.prvtDayHeight  = parseInt((auxH - 4 - options.prvtDayNumCells * 4) / options.prvtDayNumCells, 10);
			options.prvtDaySelHeight = options.prvtDayHeight + auxH - (options.prvtDayNumCells * options.prvtDayHeight + options.prvtDayNumCells * 4);
			...
			options.prvtYearWidth = parseInt((auxW - 4 - options.prvtYearNumCells * 4) / options.prvtYearNumCells, 10);
			options.prvtYearSelWidth = options.prvtYearWidth + auxW - (options.prvtYearNumCells * options.prvtYearWidth + options.prvtYearNumCells * 4);
			options.prvtMonthWidth  = parseInt((auxW - 4 - options.prvtMonthNumCells * 4) / options.prvtMonthNumCells, 10);
			options.prvtMonthSelWidth = options.prvtMonthWidth + auxW - (options.prvtMonthNumCells * options.prvtMonthWidth + options.prvtMonthNumCells * 4);
			options.prvtDayWidth  = parseInt((auxW - 4 - options.prvtDayNumCells * 4) / options.prvtDayNumCells, 10);
			options.prvtDaySelWidth = options.prvtDayWidth + auxW - (options.prvtDayNumCells * options.prvtDayWidth + options.prvtDayNumCells * 4);
